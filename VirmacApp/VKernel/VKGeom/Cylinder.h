...
class VKGEOMSHARED_EXPORT Cylinder : public BasicSurface
{
    public:
    Cylinder(){}
    Cylinder(const Circle3D&, const double& ht);
    Cylinder(const AxisSystem&, const double& ht, const double& rad, const double& uStart = 0, const double& uEnd = 2*PI);
    virtual ~Cylinder();
